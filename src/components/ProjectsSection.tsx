...
const projects = [
  ...
  {
    title: 'My profile',
    description: 'My personal portfolio website showcasing my projects, skills, and experience. It serves as a platform to highlight my work and provide information about my background and expertise.',
    techStack: ['React', 'TypeScript', 'Firebase', 'Tailwind'],
    github: 'https://github.com/Hemantpatil1/Hemant-Patil-Profile',
    live: 'https://hemantp.netlify.app/',
  },
  {
    title: 'Rx-Chain Health',
  ...
  {
    title: 'Vote-Wise',
    description: 'A System that is used as voting guide to voters to make informed decisions. It provides comprehensive information about candidates, their policies, and past performance. It also offers a user-friendly interface for voters to compare candidates side by side and make informed choices based on their preferences and values.',
    techStack: ['React', 'TypeScript', 'MongoDB', 'Node.js', 'Express'],
    github: 'https://github.com/Hemantpatil1/VoteWise',
    live: '#',
  },
  {
    title: 'Scan-Grow',
    description: 'Real-time tree health maintenance. useful for monitoring the health of trees in urban areas, parks, and forests. It provides real-time data on tree health, growth patterns, and environmental conditions, enabling proactive maintenance and conservation efforts. The system utilizes advanced sensors and data analytics to assess tree health, identify potential issues, and recommend appropriate care measures to ensure the longevity and vitality of trees in various environments.',
